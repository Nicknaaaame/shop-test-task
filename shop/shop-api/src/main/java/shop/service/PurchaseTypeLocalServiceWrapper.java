...
public class PurchaseTypeLocalServiceWrapper
     ...
     */
    @Override
    public shop.model.PurchaseType createPurchaseType(long id) {
     ...
     */
    @Override
    public shop.model.PurchaseType deletePurchaseType(long id)
            throws com.liferay.portal.kernel.exception.PortalException {
    ...
    @Override
    public shop.model.PurchaseType fetchPurchaseType(long id) {
     ...
     */
    @Override
    public shop.model.PurchaseType getPurchaseType(long id)
            throws com.liferay.portal.kernel.exception.PortalException {
